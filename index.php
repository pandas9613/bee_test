...
<head>
    ...
    <meta itemprop="name" content="這什麼Bee油" />
    <meta itemprop="description" content="新概念bee游" />
    <meta charset="utf-8" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
		...
		<button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://linkgoods.com/1fanfarm'" data-i18n="web">WEB-I18N</button>
            </div>
    </div>
    </div>
